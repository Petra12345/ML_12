...
# Parameters
name_save = "dataframe_cross_validation_dectree.csv"
name_save_average = "average_dataframe_cross_validation_dectree.csv"
...
for criterion, splitter, max_depth, min_samples_split in models:
    models_dict[
        f"decision tree: criterion={criterion} splitter={splitter} max_depth={max_depth} min_samples_split={min_samples_split}"] \
        = make_decision_tree_model(criterion=criterion, splitter=splitter, max_depth=max_depth,
